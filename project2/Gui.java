...
public class Gui extends JFrame implements KeyListener {
 ...
 private int pause = 1; //pause flag
 ...
 public void display()  //updates screen and movement of enemies and asteroids as well as 
     // sleeps the loop so there will be playable gameplay
 {
 ...
 public void changeEnemyPosition(int i, int x, int y){  //changes enemy's coordinates at given position to given x and y
 ...
 public void changeAsteroidPosition(int i, int x, int y){  //change x and y position of of asteroid at given location 
 ...
 public int getPause() {//returns the pause flag
  return pause;
 }
